...
public class Constants {
    ...
    public static final int OFFICE_PHOTO = 5;
    public static final int DISH_PHOTO = 6;
    ...
    public static final String STORE_TYPE_NAME_ID = "_id";
    ...
    public static final int    STORE_TYPE_NAME_TYPE_COL = 6;

    public static final String STORE_TYPE_NAME_SEQUENCE = "sequence";
    public static final int    STORE_TYPE_NAME_SEQUENCE_COL = 7;

    public static final String STORE_TYPE_NAME_MEDIA_URL = "media_url";
    public static final int    STORE_TYPE_NAME_MEDIA_URL_COL = 8;
    ...
    public static final String SUBTITLE_COLOR_R= "color_r";
    public static final int    SUBTITLE_COLOR_R_COL = 18;

    public static final String SUBTITLE_COLOR_G= "color_g";
    public static final int    SUBTITLE_COLOR_G_COL = 19;

    public static final String SUBTITLE_COLOR_B = "color_b";
    public static final int    SUBTITLE_COLOR_B_COL = 20;

    public static final String SUBTITLE_ALPHA = "alpha";
    public static final int    SUBTITLE_ALPHA_COL = 21;

    public static final String SUBTITLE_LOCATION= "location";
    public static final int    SUBTITLE_LOCATION_COL = 22;

    public static final String SUBTITLE_SPEED = "speed";
    public static final int    SUBTITLE_SPEED_COL = 23;

    public static final String SUBTITLE_TEXT_CONTENT = "text_content";
    public static final int    SUBTITLE_TEXT_CONTENT_COL = 24;

    public static final String CREATE_SUBTITLE_TABLE =
            "CREATE TABLE " + SUBTITLE_TABLE + " (" +
                    SUBTITLE_SCREENSUBTITLE_ID + " INTEGER, " +
                    ...
                    SUBTITLE_DATA_DELETED    + " INTEGER NOT NULL, " +
                    ...
                    SUBTITLE_COLOR_R  + " INTEGER, " +
                    SUBTITLE_COLOR_G  + " INTEGER, " +
                    SUBTITLE_COLOR_B  + " INTEGER, " +
                    SUBTITLE_ALPHA  + " INTEGER, " +
    ...
    public static final String STORE_OFFICE_ID = "_id";
    ...
    public static final String CREATE_STORE_OFFICE_TABLE =
            "CREATE TABLE " + STORE_OFFICE_TABLE + " (" +
                    ...
                    STORE_OFFICE_DELETED    + " INTEGER NOT NULL, " +
    ...
    public static final String DISH_TABLE = "screenshow";
    ...
    public static final String DISH_STORE_TYPE_ID = "show_type_id";
    ...
    public static final String CREATE_MEDIA_TABLE =
            "CREATE TABLE " + MEDIA_TABLE + " (" +
                    ...
                    MEDIA_DATA_DELETED    + " INTEGER NOT NULL, " +
                    ...
                    MEDIA_END_DATE  + " TEXT, " +
                    MEDIA_SHOW_TYPE  + " INTEGER NOT NULL, " +
    ...
    public static final int    BRANCH_INFO_COL = 16;
