package com.zhixiangzhonggong.tiebaobei.util;
...
import com.zhixiangzhonggong.tiebaobei.Activity.SellCarInformationActivity;
    ...
    public void displayBmp(final ImageView iv, final String thumbPath,
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (thumb == null) {
                    thumb = SellCarInformationActivity.bimap;
                }
